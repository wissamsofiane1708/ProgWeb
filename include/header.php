...
<html>
    ...
    <head>
        ...
        <a class=" position-sticky btn-lg active badge-light border border-primary pull-right" href="Connexion.php">Espace personnel</a>
        </div>
        ...
        <div class="position-relative col-md-8 " style="text-align:center">
                ...
                <a class="position-relative btn-lg active badge-info border border-primary" style ="left: 200px" href="eleve.php">Eleves</a>
                <a class="position-relative btn-lg active badge-info border border-primary" style ="left: 300px" href="gestionnaire.php">Gestionnaires</a>
